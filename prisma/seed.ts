...
async function main() {
  ...
  const umkmData = [
    ...
    {
      phone: "08444444416",
      email: "kopi.kulonprogo@synergy.id",
      ownerName: "Bagus Santoso",
      businessName: "Kopi Kulon Progo",
      businessCategory: "Kuliner / F&B",
      businessDescription: "Produsen biji kopi lokal berkualitas tinggi dari perbukitan Menoreh Kulon Progo. Menggunakan proses sangrai modern dan pemberdayaan petani lokal.",
      location: "Girimulyo",
      city: "Kulon Progo",
    ...
    {
      phone: "08444444417",
      email: "batik.mataram@synergy.id",
      ownerName: "Ratna Sari",
      businessName: "Batik Mataram Craft",
      businessCategory: "Kerajinan & Fashion",
      businessDescription: "Produsen batik tulis dan cap dengan pewarna alami ramah lingkungan. Berpengalaman dalam mengekspor produk kerajinan ke pasar Asia & Eropa.",
      location: "Ngampilan",
      city: "Yogyakarta",
      province: "D.I. Yogyakarta",
    ...
    {
      phone: "08444444418",
      email: "tani.organik@synergy.id",
      ownerName: "Wahyu Hidayat",
      businessName: "Tani Organik Sleman",
      businessCategory: "Pertanian & Perkebunan",
      businessDescription: "Kelompok tani terpadu yang memproduksi berbagai jenis sayur dan buah organik bersertifikat dengan jaringan distribusi supermarket modern.",
    ...
    {
      phone: "08444444419",
      email: "keripik.bantul@synergy.id",
      ownerName: "Siti Aminah",
      businessName: "Keripik Singkong Bantul",
      businessCategory: "Olahan Makanan",
      businessDescription: "Industri rumah tangga pengolahan keripik singkong renyah dengan berbagai varian rasa kekinian, telah terdaftar PIRT dan Halal.",
  ...
  const creditScoreData = [
    ...
    { idx: 5, score: 88, risk: RiskLevel.LOW },
    { idx: 6, score: 82, risk: RiskLevel.LOW },
    { idx: 7, score: 74, risk: RiskLevel.MEDIUM },
    { idx: 8, score: 91, risk: RiskLevel.LOW },
  ];
  ...
  const campaignDefs = [
    ...
    {
      profileIdx: 5,
      title: "Kopi Kulon Progo",
      story: "Produsen biji kopi lokal berkualitas tinggi dari perbukitan Menoreh Kulon Progo. Menggunakan proses sangrai modern dan pemberdayaan petani lokal.",
    ...
    {
      profileIdx: 6,
      title: "Batik Mataram Craft",
      story: "Produsen batik tulis dan cap dengan pewarna alami ramah lingkungan. Berpengalaman dalam mengekspor produk kerajinan ke pasar Asia & Eropa.",
    ...
    {
      profileIdx: 7,
      title: "Tani Organik Sleman",
      story: "Kelompok tani terpadu yang memproduksi berbagai jenis sayur dan buah organik bersertifikat dengan jaringan distribusi supermarket modern.",
    ...
    {
      profileIdx: 8,
      title: "Keripik Singkong Bantul",
      story: "Industri rumah tangga pengolahan keripik singkong renyah dengan berbagai varian rasa kekinian, telah terdaftar PIRT dan Halal.",
