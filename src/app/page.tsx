          ...
          <div className={styles.aboutInner}>
            ...
            <div className={styles.aboutContent}>
              ...
              <p className={styles.aboutText}>
                ...
                <strong>Kecerdasan Buatan</strong> yang dipadukan dengan konsep
                ekonomi syariah, mengimplementasikan akad <em>Musyarakah</em>{" "}
                dan <em>Mudharabah</em> pada pembiayaan UMKM.
              </p>
              <p className={styles.aboutText}>
        ...
        <section id="teknologi" className={styles.problem}>
          <ScrollReveal>
            ...
            <p className={styles.sectionSubtitle}>
              ...
              ekonomi nasional sebesar 8%, namun tiga hambatan kritis menghambat
            ...
            <div className={styles.statsGrid}>
              ...
              <div className={`${styles.statCard} glass`}>
                ...
                <p className={styles.statDesc}>
                  Sistem perbankan konvensional rawan terhadap kegagalan sistem
                  tunggal dan ancaman kebocoran data terpusat.
                </p>
              </div>
              <div className={`${styles.statCard} glass`}>
                ...
                <p className={styles.statDesc}>
                  Belum adanya sistem penilaian risiko otomatis yang transparan
                  dan inklusif bagi pelaku usaha tanpa riwayat kredit bank.
                </p>
              </div>
            </div>
            ...
            <div className={`${styles.solutionBox} glass`}>
              ...
              <div>
                ...
                <p>
                  ...
                  <strong>Blockchain</strong> yang aman, serta skoring kelayakan
                  UMKM yang akurat menggunakan <strong>AI (XGBoost)</strong>{" "}
                  demi mewujudkan pemerataan ekonomi digital yang transparan.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className={styles.featureGrid}>
              ...
              <div className={`${styles.featureCard} glass`}>
                ...
                <p>
                  ...
                  <strong>Extreme Gradient Boosting (XGBoost)</strong> berbasis
                  Python. Menganalisis data transaksi, listrik, dan arus kas
                ...
                <div className={styles.featureIconWrap}>
                  ...
                  >
                    ...
                    <line
                      ...
                      strokeLinecap="round"
                    />
                    <circle cx="9" cy="24" r="2" fill="#00D2FF" opacity="0.6" />
                    <circle
                      cx="39"
                      cy="24"
                      r="2"
              ...
              <div className={`${styles.featureCard} glass`} id="akad">
                ...
                <p>
                  ...
                  didigitalisasikan, memastikan seluruh proses investasi selaras
        ...
        <div className={styles.footerInner}>
          <div className={styles.footerTop}>
            ...
            <div className={styles.footerBrand}>
              ...
              <p>
                Ekosistem pembiayaan syariah berbasis AI &amp; Blockchain untuk
                UMKM Indonesia yang inklusif dan transparan.
              </p>
