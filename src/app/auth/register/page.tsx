          ...
          <div className={styles.modalOverlay}>
            <div className={styles.modalCard}>
              ...
              <p className={styles.modalDesc}>
                Selamat! Akun {account.role === "INVESTOR" ? "Investor" : "UMKM"} Anda telah berhasil dibuat. Silakan masuk untuk mengakses layanan Synergy.
              </p>
              <button
                type="button"
              ...
              <>
                ...
                <div className={styles.form}>
                  ...
                  <button
                    ...
                    onClick={() => alert("Fitur Daftar dengan Google akan terhubung setelah mengonfigurasi Client ID Google OAuth.")}
                  >
